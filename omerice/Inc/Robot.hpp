...
public:
	...
	Robot(SPI_HandleTypeDef *_hspi2,SPI_HandleTypeDef *_hspi3,TIM_HandleTypeDef *_htim1,
			TIM_HandleTypeDef *_htim2,TIM_HandleTypeDef *_htim3,TIM_HandleTypeDef *htim8)
			:en_a(_htim2,500,5),en_b(_htim3,500,5),m_a(_htim1),m_b(_htim1),m_c(_htim1),pspad(_hspi2),gyro(_hspi3),servoa(htim8),servob(htim8){}
